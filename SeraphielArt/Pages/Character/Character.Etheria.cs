...
public static partial class CharacterList
{
    public static partial class Etheria
    {
        public class AliceBlessland : CharacterBase
        {
            ...
            public override CharacterVersion[] Versions =>
            [
                HumanEtherian,
                Vampire,
            ];
...
")
    ...
    public static partial class Etheria
    {
        static readonly CharacterVersion AliceHuman = new(
        ...
        static readonly CharacterVersion AliceVampire = new(
            Character: AliceBlessland.Self,
        ...
        static readonly CharacterVersion EdgarHomunculus = new(
        ...
        static readonly CharacterVersion EdgarSerpentLord = new(
            Character: EdgarCrowbell.Self,
        ...
        static readonly CharacterVersion EdgarSerpent = new(
            Character: EdgarCrowbell.Self,
            Species: Species.HomunculusEtheria | Species.ArtificialHybridian,
            Faction: Faction.Etherian,
            Strength: 8,
        ...
        static readonly CharacterVersion EdgarSeraph = new(
            Character: EdgarCrowbell.Self,
